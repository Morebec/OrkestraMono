...
{
    public const MESSAGING_ROUTING_AUTOROUTE_TAG = 'orkestra.orkestra-messaging.routing.autoroute';
    public const MESSAGING_ROUTING_DISABLED_METHOD_TAG = 'orkestra.orkestra-messaging.routing.disabled_method';
    ...
    /**
     * Disables a certain orkestra-messaging method route.
     *
     * @return $this
     */
